...
.grid{gap:4px}.card img,.rawRow img,.filmstrip img{object-fit:contain}.grid.browse{gap:3px;padding:3px 3px 100px;grid-template-columns:repeat(auto-fill,minmax(112px,1fr))}.grid.browse .card{border-radius:3px;background:#050505}.grid.browse .card img{height:138px}.grid.browse .meta{padding:5px}.grid.browse .issue,.grid.browse .group{display:none}.previewStage{touch-action:none}.previewCanvas{width:100%;height:100%;display:grid;place-items:center;transform-origin:center;will-change:transform}.previewCanvas img{grid-area:1/1}
</style></head><body>
